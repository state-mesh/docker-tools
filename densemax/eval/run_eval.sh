...
export MODEL_TOKENIZER

# Generation parameters
export MODEL_TEMPERATURE="${MODEL_TEMPERATURE:-}"
export MODEL_TOP_P="${MODEL_TOP_P:-}"
export MODEL_TOP_K="${MODEL_TOP_K:-}"
export MODEL_MIN_P="${MODEL_MIN_P:-}"
export MODEL_PRESENCE_PENALTY="${MODEL_PRESENCE_PENALTY:-}"
export MODEL_ENABLE_THINKING="${MODEL_ENABLE_THINKING:-}"
...
echo " MODEL_TOKENIZER: ${MODEL_TOKENIZER:-auto}"
...
echo " MODEL_TEMPERATURE: ${MODEL_TEMPERATURE:-default}"
echo " MODEL_TOP_P: ${MODEL_TOP_P:-default}"
echo " MODEL_TOP_K: ${MODEL_TOP_K:-default}"
echo " MODEL_MIN_P: ${MODEL_MIN_P:-default}"
echo " MODEL_PRESENCE_PENALTY: ${MODEL_PRESENCE_PENALTY:-default}"
echo " MODEL_ENABLE_THINKING: ${MODEL_ENABLE_THINKING:-default}"
echo "=========================================="
